...
class SystemServiceRegistry(ServiceRegistry):
    ...
    async def initialize(cls, directory: BaseControllerDirectory):
        await cls.audit.initialize(directory)
        await cls.renderer.initialize(directory)
        await cls.counters.initialize(directory)
        await cls.sessions.initialize(directory)
        await cls.namespaces.initialize(directory)
