...
from yakoon.base.models.workflow import WorkflowDef
...
class WorkflowService(Protocol):
    ...
    def apply_prompt_value(self, session: Any, *, batch_id: str, step_id: str, value: Any) -> None: ...
    def advance_after_run(self, session: Any, *, batch_id: str, step_id: str) -> None: ...
    ...
    def runtime(self, session: Any) -> Any: ...

    def start(self, session, controller_id: str, workflow_key: str, *, enqueue_first: bool = True) -> str: ...
    def start_with_values(self, session, controller_id: str, workflow_key: str, values: Mapping[str, Any], *,
