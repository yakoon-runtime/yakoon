...
class RendererService(ControllerService):
    ...
    async def initialize(self, directory: BaseControllerDirectory):
        await self._engine.build_environment(
            [c.template_source for c in directory.get_all_for()])      
