...
from yakoon.saas.domains.realm.models.climate_zone import ClimateZone
from yakoon.saas.domains.realm.stores.memory.climate_zone import InMemoryClimateZoneStore
