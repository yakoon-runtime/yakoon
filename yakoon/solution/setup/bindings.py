...
def bind_active_storage(mode: str = "memory"):
    ...
    """
    if mode == "memory":
        from yakoon.domains.platform.stores.memory._bindings import bind_memory_storages
        bind_memory_storages()

    elif mode == "sqlite":
        from yakoon.domains.platform.stores.sql._bindings import bind_sql_storages
        bind_sql_storages()
