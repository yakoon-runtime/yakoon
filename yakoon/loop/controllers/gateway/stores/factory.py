...
from yakoon.loop.controllers.gateway.stores.memory._registry import MemoryStoreRegistry
...
def create_gateway_stores(backend: str, *, db_path: str = None, pool=None) -> StoreRegistry:
    ...
    if backend == "sqlite":
        from yakoon.saas.controllers.gateway.stores.sqlite._registry import SQLiteStoreRegistry
