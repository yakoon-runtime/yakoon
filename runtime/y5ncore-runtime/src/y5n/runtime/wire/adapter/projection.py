"""Adapter: projection port for SDK.

Registered as ``"projection"`` on the Runtime Bus.
...
class ProjectionAdapter:
    ...
    def render(
        ...
        *,
        ...
        variants = (node.resources or {}).get("projection", {})
        template_path = variants.get(lang) or variants.get(name) or variants.get("default")
